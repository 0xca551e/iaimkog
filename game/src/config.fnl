...
(set _G.title-screen-music (love.audio.newSource "sound/sideways_city_loop.ogg" "static"))
(_G.title-screen-music:setLooping true)
(_G.title-screen-music:setVolume 0.4)
(set _G.course-1-music (love.audio.newSource "sound/apple_cider.ogg" "static"))
(_G.course-1-music:setLooping true)
(_G.course-1-music:setVolume 0.5)
(set _G.course-2-music (love.audio.newSource "sound/barriers.ogg" "static"))
