(fn _G.generate-ball-preview []
  (set _G.ball-preview [])
  (var preview-ball {:position _G.ball.position :velocity (_G.shot.velocity-vector _G.shot.type _G.shot.angle 1) :radius _G.ball.radius :collided false :just-collided false})
  (for [i 0 200 1]
